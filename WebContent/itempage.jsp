...
<link
	...
	rel="stylesheet">
<!--fontawesome-->
<script src="https://kit.fontawesome.com/ff96cc4049.js"
...
<body>
	...
	<div class="wrapper">
		<div class="placeorder">
			<!--order place: seller로 로그인했을 때만 나타나는 항목-->
		</div>
		<div class="category">
	...
	<div class="contents">
		<!-- 아이템 상세 페이지 -->
		<div class="itempic">
			<img src="../images/${product.getImg()}"></img>
		</div>
		<div class="itemdetail">
			...
			<div class="group">
				...
				<div class="groupdetail">
					<!--내용-->
					call me 010-1234-5678 adse 12 313 1zsdf AS
				</div>
			</div>
		</div>
		<div>
			<a
				href="${pageContext.request.contextPath}/cart?&action=buy&id=${product.getID()}"
				class="button">Buy</a>
		</div>
		<div class="itemcomment">
			<!--바이어가 덧글, 입찰-->
			<textarea class="itemcommenttext" rows="8" cols="80"></textarea>
			<br>
			<button class="commentsubmit">submit</button>
		</div>
		<div class="commentlist">
			<!--현재까지의 덧글목록 (역순정렬, 등록일시 표시)-->
		</div>
	</div>
</body>
</html>