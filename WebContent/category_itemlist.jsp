	...
	<div class="wrapper">
		<div class="category">
			<ul class="categorylist">
				...
				<li><a href="Servlet?command=category&category=Computers">Computers</a></li>
				<li><a href="Servlet?command=category&category=Electronics">Electronics</a></li>
				<li><a href="Servlet?command=category&category=Fashion">Fashion</a></li>
				<li><a href="Servlet?command=category&category=Furnitures">Furnitures</a></li>
				<li><a href="Servlet?command=category&category=Health">Health</a></li>
				<li><a href="Servlet?command=category&category=Industrial">Industrial</a></li>
				<li><a href="Servlet?command=category&category=Kitchen">Kitchen</a></li>
				<li><a href="Servlet?command=category&category=Pet Supplies">Pet
						Supplies</a></li>
